...
const numsTimesTwo = nums.map((element) => {
  return element * 2;
});

console.log("\nExercise 1:");
console.log("Nums times two array: " + numsTimesTwo);
...
console.log("\nExercise 2:");
console.log("First pizza indgredient: " + firstIngredient);
console.log("Second pizza indgredient: " + secondIngredient);
...
console.log("\nExercise 3:");
console.log("Make of the car: " + make);
...
console.log("\nExercise 4:");
console.log(
  "Uncontroversial pizza toppings array: " + uncontroversialPizzaToppings
);
...
function defaultParameter(noun = "cat", adjective = "orange") {
  console.log("\nExercise 8:");
  console.log(`The ${noun} is ${adjective}`);
}

defaultParameter("bird", "green");
...
console.log("\nExercise 9:");
pizza === "tasty" ? console.log("pizza is yum") : console.log("pizza is yuck");
